...
public class PlayerUtils
{
    ...
    public static boolean placeBlock(final BlockPos blockPos, final int slot, final Hand hand) {
        ...
        final int preSlot = PlayerUtils.mc.player.getInventory().selectedSlot;
        PlayerUtils.mc.player.getInventory().selectedSlot = slot;
        final boolean a = placeBlock(blockPos, hand, true);
        PlayerUtils.mc.player.getInventory().selectedSlot = preSlot;
        return a;
    }
