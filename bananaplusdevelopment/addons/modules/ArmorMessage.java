            ...
            if (player.isAlive()) {
                ...
                for (final ItemStack stack : player.getInventory().armor) {
                    ...
                    if (percent <= (int)this.armorThreshhold.get() && !this.entityArmorArraylist.containsKey(player)) {
                        ...
                        this.entityArmorArraylist.put(player, player.getInventory().armor.indexOf((Object)stack));
                    }
                    if (!this.entityArmorArraylist.containsKey(player) || this.entityArmorArraylist.get(player) != player.getInventory().armor.indexOf((Object)stack)) {
                        continue;
                    }
                ...
                if (player.getInventory().armor.get((int)this.entityArmorArraylist.get(player)) != ItemStack.EMPTY) {
                    continue;
                }
                this.entityArmorArraylist.remove(player);
            }
