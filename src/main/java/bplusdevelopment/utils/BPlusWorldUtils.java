...
import bplusdevelopment.addons.modules.SurroundPlus;
...
public class BPlusWorldUtils {
    ...
    public static void snapPlayer() {
        BlockPos lastPos = mc.player.isOnGround() ? BPlusWorldUtils.roundBlockPos(mc.player.getPos()) : mc.player.getBlockPos();
        snapPlayer(lastPos);
    }
