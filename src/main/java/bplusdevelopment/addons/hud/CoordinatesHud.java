...
public class CoordinatesHud extends HudElement {
    ...
    private final Setting<Integer> xSpoof = sgGeneral.add(new IntSetting.Builder().name("X-Spoof").description("Changes your X by this amount.").defaultValue(0).min(-2147483648).max(2147483647).sliderMin(-2147483648).sliderMax(2147483647).build());
    private final Setting<Integer> ySpoof = sgGeneral.add(new IntSetting.Builder().name("Y-Spoof").description("Changes your Y by this amount.").defaultValue(0).min(-2147483648).max(2147483647).sliderMin(-2147483648).sliderMax(2147483647).build());
    private final Setting<Integer> zSpoof = sgGeneral.add(new IntSetting.Builder().name("Z-Spoof").description("Changes your Z by this amount.").defaultValue(0).min(-2147483648).max(2147483647).sliderMin(-2147483648).sliderMax(2147483647).build());
