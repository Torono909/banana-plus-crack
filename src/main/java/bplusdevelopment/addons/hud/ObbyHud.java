...
public class ObbyHud extends HudElement {
    ...
    private final Setting<Double> scale = sgGeneral.add(new DoubleSetting.Builder().name("scale").description("Scale of obsidian counter.").defaultValue(3).min(1).sliderMin(1).sliderMax(4).build());
