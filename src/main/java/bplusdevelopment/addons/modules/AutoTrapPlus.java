...
public class AutoTrapPlus extends Module {
    ...
    public void onActivate() {
        ...
        lastPos = target.isOnGround() ? BPlusWorldUtils.roundBlockPos(target.getPos()) : target.getBlockPos();
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        BlockPos roundedPos = BPlusWorldUtils.roundBlockPos(target.getPos());
        if (onlyGround.get() && !target.isOnGround() && roundedPos.getY() <= lastPos.getY()) {
            lastPos = BPlusWorldUtils.roundBlockPos(target.getPos());
        }
