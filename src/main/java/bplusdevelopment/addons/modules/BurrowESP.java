...
public class BurrowESP extends Module {
    ...
    public BurrowESP() {
        super(AddModule.BANANAPLUS, "Burrow-ESP", "Displays if the closest target to you is burrowed / webbed.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        isTargetBurrowed = (target != null && BPlusEntityUtils.isBurrowed(targetEntity));
    }
