...
public class CrystalClear extends Module {
    ...
    private boolean entityCheck(Entity entity) {
        ...
        if (BPlusPlayerUtils.distanceTo(entity) > range.get()) return false;
        if (!entities.get().getBoolean(entity.getType())) return false;
        if (!PlayerUtils.canSeeEntity(entity) && BPlusPlayerUtils.distanceTo(entity) > wallsRange.get()) return false;
