...
public class AutoSex extends Module {
    ...
    private final Setting<List<String>> messages = sgSex.add(new StringListSetting.Builder().name("messages").description("Messages to use for dirty talk.").defaultValue(List.of("Please cum inside me (enemy)!", "Ahhh harder daddy (enemy)", "Put your cock inside me (enemy)!", "Let me swallow ur babies (enemy)", "Haah... Uugh.. Aaah...")).visible(message::get).build());
